...
namespace Misc
{
    public class BuildingController : MonoBehaviour
    {
        ...
        [SerializeField] private Vector3 turretSize = new(2.0f, 2.0f, 2.0f);
        ...
        {
            TurretManager.Instance.ClearTurrets();
        }
        ...
        private bool ValidatePlacement(RaycastHit buildingHit)
        {
            ...
            foreach (GameObject turret in TurretManager.Instance.GetTurretObjects())
            {
                float distance = Vector3.Distance(buildingHit.point, turret.transform.position);
