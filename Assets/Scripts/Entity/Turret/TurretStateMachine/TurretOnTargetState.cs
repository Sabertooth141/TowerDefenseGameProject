...
namespace Entity.Turret.TurretStateMachine
{
    public class TurretOnTargetState : ITurretState
    {
        ...
        public void Update()
        {
            ...
            if (_controller.currTarget == null || ReferenceEquals(_controller.currTarget, null))
            {
                _controller.stateMachine.ChangeState(new TurretIdleState(_controller));
                return;
            }
            ...
            Vector3 targetPosition = _controller.currTarget.transform.position;
            
            Vector3 dir = targetPosition - _controller.turretFiringPoint.position;
            ...
            Vector3 angleToTarget = (targetPosition - _controller.turretFiringPoint.position).normalized;
